...
# for boundary in "0.33_0.66" "0.2_0.4_0.6_0.8"; do #"0.5" "0.33_0.66"
...
python mlp_train.py \
    ...
    --label_mask "0,2" \
    --prefix "mlp_${task}_b${boundary}_eliminate1" \
    --split_npz /Users/chanyu/Dropbox/NeuroData2025/BIU/ML_proj/baseline_perf/hpo/mlp_cv/split_indices_${slicing_day}.npz \
    --best_param /Users/chanyu/Dropbox/NeuroData2025/BIU/ML_proj/baseline_perf/hpo/mlp_cv/hpo_${boundary}_slicing1_eliminate-center.json \
